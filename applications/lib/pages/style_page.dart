    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          TrendCard(
            title: "Freestyle",
            imagePath: 'assets/image/free.jpg', // Ganti dengan path gambar Anda
            onTap: () {
          ...
          TrendCard(
            title: "Breaststroke",
            imagePath: 'assets/image/breast.jpg', // Ganti dengan path gambar Anda
            onTap: () {
          ...
          TrendCard(
            title: "Butterfly",
            imagePath: 'assets/image/butterfly.jpg', // Ganti dengan path gambar Anda
            onTap: () {
          ...
          TrendCard(
            title: "Backstroke",
            imagePath: 'assets/image/back.jpg', // Ganti dengan path gambar Anda
            onTap: () {
